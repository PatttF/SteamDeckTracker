...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/pat/Desktop/SteamDeckTracker/ffmpeg-build/install --enable-static --disable-shared --enable-gpl --disable-programs --disable-doc --disable-debug --disable-encoders --disable-decoders --disable-muxers --disable-demuxers --enable-decoder='pcm_s16le,pcm_s24le,pcm_f32le,aac,mp3,flac,vorbis' --enable-demuxer='mov,mp4,matroska,mp3,flac,wav' --enable-parser='aac,mp3' --enable-protocol=file --enable-avformat --enable-avcodec --enable-avutil --enable-swresample --enable-swscale --enable-avfilter
...
EXTRALIBS-avfilter=-pthread -lm -latomic -lz -lva
EXTRALIBS-swscale=-lm -latomic
EXTRALIBS-avformat=-lm -latomic -lbz2 -lz
EXTRALIBS-avcodec=-pthread -lm -latomic -lz -lva
EXTRALIBS-swresample=-lm -latomic
EXTRALIBS-avutil=-lva-drm -lva -lva-x11 -lva -lvdpau -lX11 -lm -lz -ldrm -lva -latomic -pthread -lX11
